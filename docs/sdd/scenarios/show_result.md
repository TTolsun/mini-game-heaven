...
CastleScene이 상태 전환을 감지해 저장하고 결과 화면을 표시합니다. 이미 지급된 재화와 다음 준비 날짜를 함께 저장하므로 결과 화면에서 앱이 종료되어도 보상을 다시 지급하지 않습니다. `app/castle/CastleScene.cpp:48`, `app/castle/CastleModel.cpp:197`
