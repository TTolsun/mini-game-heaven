...
preview는 모델 복사본에서 execute를 호출합니다. Outcome의 고정 크기 이벤트 목록으로 이동·충돌·추격 등을 표현합니다. 판정은 프레임 시간과 분리되며 표시는 0.55초 보간과 피드백을 사용합니다. 근거: app/srpg/BattleModel.cpp, BattleScene.cpp.
