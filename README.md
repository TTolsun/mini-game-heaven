...
C++20 Android 무술 SRPG입니다. 무천도사의 어린 시절부터 손오공과의 만남까지를 그리며, 현재 0.5.0은 첫 장의 플레이 루프를 검증하는 다섯 맵 시제품입니다.
...
세로 화면과 임시 도형 캐릭터를 사용합니다. 절벽 추락·지형 파괴·장비 상점·분기 엔딩·전체 성장기 캠페인은 구현하지 않았습니다.
...
- BattleData는 콘텐츠와 수치, BattleModel은 캠페인·전투·저장, BattleScene은 화면·입력·표현을 담당합니다. 모델은 Android/GLES에 의존하지 않습니다.
